...
baseplot = function(p) 
  ggplot(p, aes(y = depth, color = id)) + scale_x_continuous(breaks = pretty_breaks()) +
...
lyrs = list(
  ...
  sat = geom_path(aes(x = sat)),
  da = geom_path(aes(x = fl)),
  bt = geom_path(aes(x = bt))
)
